...
@ComponentScan(basePackages = { "io.github.lvoxx.srms" }, excludeFilters = {
                @ComponentScan.Filter(type = FilterType.REGEX, pattern = "io.github.lvoxx.srms.contactor.repositories.*"),
                @ComponentScan.Filter(type = FilterType.REGEX, pattern = "io.github.lvoxx.srms.contactor.config.*"),
