    ...
    class ServiceExceptionTests {
        ...
        void shouldReturn404WhenContactorNotFoundById() {
            ...
            Mockito.when(contactorService.findById(nonExistentId))
                    .thenReturn(
                            Mono.error(new NotFoundException("Contactor not found with id " + nonExistentId + ".")));
            ...
            webTestClient.get()
                    ...
                    .expectBody()
                    .jsonPath("$.details")
                    .value(org.hamcrest.Matchers.containsString("Contactor not found with id " + nonExistentId));
        }
        ...
        void shouldReturn404WhenUpdatingNonExistentContactor() throws Exception {
            UUID nonExistentId = UUID.randomUUID();
            Mockito.when(contactorService.updateContactor(Mockito.eq(nonExistentId),
                    Mockito.any(ContactorDTO.Request.class)))
                    .thenReturn(Mono.error(new NotFoundException(
                            "Contactor not found with id " + nonExistentId + ". Or already deleted.")));
        ...
        void shouldReturn409WhenCreatingContactorWithExistingEmail() throws Exception {
            ...
            Mockito.when(contactorService.create(Mockito.any(ContactorDTO.Request.class)))
                    .thenReturn(Mono.error(
                            new ConflictException("Contactor with email " + existingEmail + " is already existed.")));
            ...
            webTestClient.post()
                    ...
                    .jsonPath("$.details").value(org.hamcrest.Matchers
                            .containsString("Contactor with email " + existingEmail + " is already existed"));
        }
        ...
        void shouldReturn500WhenCreateOperationFails() throws Exception {
            ...
            Mockito.when(contactorService.create(Mockito.any(ContactorDTO.Request.class)))
                    .thenReturn(Mono.error(
                            new DataPersistantException("Failed to create contactor with email " + testEmail + ".")));
            ...
            webTestClient.post()
                    ...
                    .jsonPath("$.details")
                    .value(org.hamcrest.Matchers.containsString("Failed to create contactor with email " + testEmail));
        }
        ...
        void shouldReturn500WhenUpdateOperationFails() throws Exception {
            ...
            Mockito.when(contactorService.updateContactor(Mockito.eq(testId), Mockito.any(ContactorDTO.Request.class)))
                    .thenReturn(Mono.error(
                            new DataPersistantException("Failed to update contactor with email " + testEmail + ".")));
            ...
            webTestClient.put()
                    ...
                    .expectBody()
                    .jsonPath("$.details")
                    .value(org.hamcrest.Matchers.containsString("Failed to update contactor with email " + testEmail));
        }

        @Test
        @DisplayName("Should return 500 when delete operation fails")
        void shouldReturn500WhenDeleteOperationFails() {
            Mockito.when(contactorService.deleteContactor(testId))
                    .thenReturn(Mono
                            .error(new DataPersistantException("Failed to delete contactor with id " + testId + ".")));
            ...
            webTestClient.delete()
                    ...
                    .expectBody()
                    .jsonPath("$.details")
                    .value(org.hamcrest.Matchers.containsString("Failed to delete contactor with id " + testId));
        }

        @Test
        @DisplayName("Should return 500 when restore operation fails")
        void shouldReturn500WhenRestoreOperationFails() {
            Mockito.when(contactorService.restoreContactor(testId))
                    .thenReturn(Mono.error(
                            new DataPersistantException("Failed to restore contactor with email " + testId + ".")));
            ...
            webTestClient.patch()
                    ...
                    .expectStatus().is5xxServerError()
                    .expectBody()
                    .jsonPath("$.details").value(org.hamcrest.Matchers.containsString("Failed to restore contactor"));
        }
        ...
        void shouldReturn404WhenDeletingNonExistentContactor() {
            UUID nonExistentId = UUID.randomUUID();
            Mockito.when(contactorService.deleteContactor(nonExistentId))
                    .thenReturn(
                            Mono.error(new NotFoundException("Contactor not found with id " + nonExistentId + ".")));
        ...
        void shouldReturn404WhenRestoringNonExistentContactor() {
            UUID nonExistentId = UUID.randomUUID();
            Mockito.when(contactorService.restoreContactor(nonExistentId))
                    .thenReturn(
                            Mono.error(new NotFoundException("Contactor not found with id " + nonExistentId + ".")));
    ...
    class EdgeCasesTests {
        ...
        void shouldHandleMultipleValidationErrors() throws Exception {
            ...
            webTestClient.post()
                    ...
                    .jsonPath("$.errors[?(@.field == 'organizationName')].error").value(
                            Matchers.containsInAnyOrder("Organization name must be between 1 and 100 characters"));
        }
    }
